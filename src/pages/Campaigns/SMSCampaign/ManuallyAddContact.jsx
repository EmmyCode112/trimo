      ...
      >
        ...
        <div className="flex flex-col mt-3 h-full">
          ...
          <div className="flex flex-col gap-3 justify-between h-full w-full">
            <form className="mt-[28px] flex flex-col justify-between items-between w-full h-full">
              <div className="flex flex-col gap-y-[18px]">
                ...
                <div>
                  {error && (
                    <div className="flex bg-[#FBF1E6] items-start border  mt-[40px] border-[#E29133] gap-3 p-4 rounded-[8px]">
            ...
            <div className="self-end justify-self-end align-end flex items-center gap-3 mt-3 mb-3">
              <Button
                label="Cancel"
                onClick={onClose}
...
export default ManuallyAddContact;
