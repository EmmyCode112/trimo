    ...
    <div className="space-y-[22px]">
      <div>
        ...
        <div className="flex items-center max-w-[392px] h-[118px] gap-[10px] justify-between  rounded-lg">
          <div className="flex w-full items-center gap-[22px]">
            <div className="w-[68px] h-[68px] rounded-full bg-[#F1F1F1]" />
            <Button label="Upload Profile" className="w-[121px] flex items-center justify-center rounded-[8px] text-[#344054] h-[36px] text-[12px] whitespace-nowrap font-medium" />
          </div>
        </div>
      ...
      <div className="relative">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="hidden lg:flex w-[101px] text-[#344054] h-[36px] px-4 py-2 border border-[#D0D5DD] rounded-[8px] text-[12px] justify-center items-center bg-white hover:bg-gray-100" onClick={onEditClick}>
            Edit Profile
          </button>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <input type="text" value="Owai Owai" readOnly className="input" />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex input">
              <input type="text" value="NG" readOnly className="w-[51px] flex items-center justify-center text-center py-2 border-none outline-none bg-transparent" />
              <input
                type="text"
